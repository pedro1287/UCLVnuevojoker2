...
def processFile(update,bot,message,file,obten_name,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.sendMessage(-1909230927,finishInfo+'\n'+filesInfo,parse_mode='html')
        if len(files)>0:
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        tl_admin_user = os.environ.get('Penelopeplp','JAGB2021')
        ...
        if username == tl_admin_user or user_info:  # validate user
            ...
            bot.sendMessage(-1909230927,intento_msg)
            return
...
def main():
    ...
    bot_token = '5645329397:AAGsT3O5Q1DYK25bZZ9KOLF49GabOqdFHAI'
